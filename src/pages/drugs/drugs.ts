...
import { NavController, AlertController, Content, IonicPage, LoadingController, Loading } from 'ionic-angular';
...
export class DrugsPage {
  ...
  constructor(public alertCtrl: AlertController, public navCtrl: NavController, private drugsService: DrugsService, private ga: GoogleAnalytics, private splashScreen: SplashScreen, private loadingCtrl: LoadingController) {
