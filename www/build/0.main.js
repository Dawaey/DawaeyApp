...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__drugs__ = __webpack_require__(846);
...
MainModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["b" /* NgModule */])({
        ...
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__drugs__["a" /* DrugsPage */]),
        ],
        exports: [
            __WEBPACK_IMPORTED_MODULE_2__drugs__["a" /* DrugsPage */]
        ]
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__providers_drugs_service__ = __webpack_require__(481);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ionic_angular__ = __webpack_require__(168);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_google_analytics__ = __webpack_require__(169);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_splash_screen__ = __webpack_require__(170);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_fuse_js__ = __webpack_require__(850);
...
var DrugsPage = (function () {
    function DrugsPage(alertCtrl, navCtrl, drugsService, ga, splashScreen, loadingCtrl) {
        ...
        this.drugsInitial = []; //initialize your drugsInitial array empty
        this.drugs = []; //initialize your drugs array empty
    ...
    DrugsPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        this.isLoading = true;
        var loading = this.loading("Loading Drugs...");
        loading.present();
        this.ga.trackView('Main Screen');
        this.drugsService.getDrugs().subscribe(function (data) {
            setTimeout(function () {
                _this.splashScreen.hide();
            }, 500);
            _this.drugsInitial = data;
            console.log(_this.drugsInitial);
            _this.drugs = data;
            loading.dismiss();
    ...
    DrugsPage.prototype.doApproximate = function () {
        var _this = this;
        this.isLoading = true;
        var loading = this.loading("Loading Approximate Drugs...");
        loading.present();
        setTimeout(function () {
            _this.drugs = _this.searchApproximate();
        }, 100);
        setTimeout(function () {
            loading.dismiss();
            _this.isLoading = false;
    ...
    DrugsPage.prototype.searchApproximate = function () {
        var options = {
            shouldSort: true,
            threshold: 0.6,
            location: 0,
        ...
        var fuse = new __WEBPACK_IMPORTED_MODULE_6_fuse_js__(this.drugsInitial, options);
        return fuse.search(this.drugToSearch);
    };
    DrugsPage.prototype.loading = function (content) {
        var loading = this.loadingCtrl.create({
            content: content
        });
        return loading;
    };
    DrugsPage.prototype.filterDrugs = function (ev) {
        var _this = this;
        console.log(ev);
        ...
        if (val && val.trim() != '') {
            this.drugs = this.drugs.filter(function (drug) {
                switch (_this.searchBy) {
                    case "tradename":
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_10" /* ViewChild */])(__WEBPACK_IMPORTED_MODULE_3_ionic_angular__["h" /* Content */]),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["h" /* Content */])
